...
public class RecipeSuggesterController {
    ...
    @GetMapping("/best")
    public Recipe suggestBestRecipeFromIngredientByCountry(
            @RequestParam(
                    name = "ingredient",
                    defaultValue = "shrimp"
            ) String ingredient
    ...
    public List<Recipe> suggestBestRecipeFromIngredientByCountryAsList(
            @RequestParam(
                    name = "ingredient",
                    defaultValue = "shrimp"
            ) String ingredient
        ...
        String message = """
                Please suggest me the best 10 dish containing the ingredient {ingredient}.
                Include dish name, country of origin, and the number of calories in that dish.
                Just say "I don't know" if you don't know the answer.
                {format}
                """;
